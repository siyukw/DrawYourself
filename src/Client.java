...
public class Client {
    public static void main(String args[]) {
        ...
        System.out.println("On a scale from 1 bald to 10 very long, how long is your hair?(integer only)");
        ...
        MyFace mine = new MyFace(gender, hairLength, hairColor, eyeColor);
